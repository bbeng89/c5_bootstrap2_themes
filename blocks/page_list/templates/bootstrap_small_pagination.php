...
<?php  if ($showPagination): ?>
	<div class="pagination pagination-small pagination-centered">
		<ul>
			<li class="<?php echo $paginator->hasPreviousPage() ? "" : "disabled"; ?>">
				<?php  echo $paginator->getPrevious('&laquo; ' . t('Prev'), 'a') ?>
			</li>
			<?php  echo $paginator->getPages($wrapper = 'li') ?>
			<li class="<?php echo $paginator->hasNextPage() ? "" : "disabled"; ?>">
				<?php  echo $paginator->getNext(t('Next') . ' &raquo;', 'a') ?>
			</li>
		</ul>
	</div>
<?php  endif; ?>